        ...
        function obj = FinneeProject(Finnee_Master, type, interval)
            ...
            switch type
                case 'original'
                    ...
                    obj.Summary = table();
                    optionsProject.Dataset4Quali = 4;
                    optionsProject.Dataset4Quant = 2;
                    ...
                    % parfor ii = 1:length(file)
                        ...
                        for jj =  interval(1):interval(2)
                            ...
                            switch  Finnee_Master.Datasets.PrimaryActions{jj}
                                ...
                                case 'Derivatives'
                                   myFinnee = myFinnee.mkDerivatives(options)
            ...
            obj.Summary.Dataset4Quali = ones(size(obj.Summary, 1), 1)*optionsProject.Dataset4Quali;
            obj.Summary.Dataset4Quant = ones(size(obj.Summary, 1), 1)*optionsProject.Dataset4Quant;
